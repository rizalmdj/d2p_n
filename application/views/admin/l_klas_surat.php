	...
	<div class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">Approval & View Request</a>
			</div>
	...
	<tbody>
		...
		<tr>
			...
			<td class="ctr">
				...
				<div class="btn-group">
					<a href="<?php echo base_URL(); ?>index.php/admin/klas_surat/edt/<?php echo $b->id; ?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Approve</a>
				</div>				
				<div class="btn-group">
					<a href="<?php echo base_URL(); ?>index.php/admin/klas_surat/edt/<?php echo $b->id; ?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Reject</a>
				</div>					
			</td>
			<?php 
			} else {
